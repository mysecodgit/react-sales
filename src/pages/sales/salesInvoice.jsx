...
const SalesInvoiceDetails = () => {
  ...
  const fetchSalesInvoice = async (salesId) => {
    try {
      const { data } = await axiosInstance.post(`sales/get_sales_by_id`, {
        salesId,
      });
                  ...
                  <CardBody className="">
                    <div className="invoice-title">
                      <h4 className="float-end font-size-16">
                        Invoice # {invoiceDetail.sale.salesNo}
                      </h4>
                    ...
                    <Row>
                      <Col sm={6}>
                        <address>
                          ...
                          <React.Fragment>
                            <span>{invoiceDetail.sale.name}</span>
                            <br />
                          </React.Fragment>
                          <div className="py-1"></div>
                          <React.Fragment>
                            <span>{invoiceDetail.sale.phone}</span>
                            <br />
                          </React.Fragment>
                        </address>
                      </Col>
                    ...
                    <div className="py-2 mt-3">
                      <h3 className="font-size-15 fw-bold">Sales summary</h3>
                    </div>
